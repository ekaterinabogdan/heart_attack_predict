...
## Описание
Проект по предсказанию риска сердечного приступа на данных gfwbtynjd. Модель обучена с использованием CatBoostClassifier. Основная цель — максимально точно выявить пациентов с высоким риском.
